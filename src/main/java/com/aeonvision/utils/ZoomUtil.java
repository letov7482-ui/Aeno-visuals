...
public class ZoomUtil {
    ...
    private static final double ZOOM_MULTIPLIER = 0.23;
    ...
    public void tick(MinecraftClient client) {
        ...
        int newFov = (int) MathHelper.clamp(originalFov * currentFovMultiplier, 1.0, 170.0);
        client.options.getFov().setValue(newFov);
    }

    public void press() { keyPressed = true; }
    public void release() { keyPressed = false; }
    public void toggle() { if (enabled) release(); else press(); }
    public boolean isZooming() { return enabled; }
}
